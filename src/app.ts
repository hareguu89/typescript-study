...
function fetchCountryInfo(countryCode: string, status: CovidStatus): Promise<AxiosResponse<ICountryInfo[]>> {
...
function setChartData(data: ICountryInfo[]) {
...
function setTotalDeathsByWorld(data: ICovidSummary): void {
  deathsTotal.innerText = data.Countries.reduce((total: number, current: Country) =>
